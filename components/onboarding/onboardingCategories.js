...
const OnboardingCategories = ({ newCategories, setNewCategories, categoryQuestion, defaultCategory, customCategory, moveToIncome, enterCustom }) => {
    const emptyCategory = {
        id: 0,
        name: "",
        color: "#000000",
    ...
    return (
        <>
            ...
            {categoryQuestion &&
            <>
                <p className="text-center mb-4">Do you want to use our default categories or customize your own?
                    <PopUp title="You can always edit these categories later!" id="categories-question">
                        <span> &#9432;</span>
                    </PopUp>
                </p>
                ...
                <Row>
                    <Col className="col-12 col-md-6 col-lg-6 mb-4">
                        ...
                        <div className="text-center">
                            <Button variant="secondary" onClick={defaultCategory}>Default</Button>
                        </div>
                    </Col>
                    <Col className="col-12 col-md-6 col-lg-6 mb-4">
                        <h5 className="text-center">
                            Custom
                            <PopUp title="These are just examples, you can make your own" id="custom-categories-question">
                                <span> &#9432;</span>
                            </PopUp>
                        </h5>
                        <Table borderless className="w-75 mx-auto">
                        ...
                        <div className="text-center">
                            <Button variant="primary" onClick={customCategory}>Custom</Button>
                        </div>
                    </Col>
                </Row>
            </>
                ...
                <Row className="col-12 my-2 mx-auto">
                    ...
                    <Col className="col-12 col-md-6">
                        <h6 className="text-center mt-4 mt-md-0">
                            Categories Entered
                            <PopUp title="You can always add more categories later!" id="custom-categories-info">
                                <span> &#9432;</span>
                            </PopUp>
                        </h6>
                            ...
                            <tbody>
                                {newCategories.map(category => (
                                    <tr key={category.id} className="d-flex">
                                        ...
                                        <td className="col-4 text-end gray-background">{currencyFormatter.format(category.budget)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </Table>
