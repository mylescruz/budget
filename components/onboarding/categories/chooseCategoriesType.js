...
const ChooseCategoriesType = ({ openCustomScreen, moveToIncome }) => {
  return (
        ...
        <Row>
          <Col className="col-12 col-md-6 col-lg-6 mb-4">
            ...
            <div className="text-center">
              <Button variant="secondary" onClick={moveToIncome}>
                Default
              </Button>
            </div>
          </Col>
          <Col className="col-12 col-md-6 col-lg-6 mb-4">
            ...
            <div className="text-center">
              <Button variant="primary" onClick={openCustomScreen}>
                Custom
              </Button>
            </div>
          </Col>
...
export default ChooseCategoriesType;
