        ...
        <Row className="w-100 d-flex align-items-center">
          <Col className="col-4">
            {!fixed && subcategory.actual !== 0 ? (
              <PopUp
                title={`There are ${subcategory.name} transactions for this month. Change those in order to delete this category`}
                id={`subcategory-${subcategory.id}-delete-info`}
              >
                <span>&#9432;</span>
              </PopUp>
            ) : (
