            ...
            <Col className="col-12 col-md-8 col-lg-9">
                ...
                <Form onSubmit={confirmation} className="col-12 col-md-8 col-lg-6">
                    <Form.Group controlId="password" className="my-2">
                        <Form.Label>In order to delete your account, you must enter your password</Form.Label>
                        <Form.Control type="password" value={password} onChange={handleInput} required />
                    </Form.Group>
            ...
            <Modal show={confirmDelete} onHide={closeConfirmDelete} centered>
                ...
                <Modal.Footer>
                    <Row className="text-end">
                        ...
                        <Col><Button variant="danger" onClick={removeAccount}>Delete</Button></Col>
                    </Row>
                </Modal.Footer>
            </Modal>
        </>
