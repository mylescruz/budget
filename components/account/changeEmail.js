...
const ChangeEmail = ({ user, putUser }) => {
    const oldUser = {
        ...user,
        currentPassword: "",
        newEmail: ""
            ...
            <Col className="col-12 col-md-8 col-lg-9">
                ...
                <Form onSubmit={updateEmail} className="col-12 col-md-8 col-lg-6">
                    ...
                    <Form.Group controlId="newEmail" className="my-2">
                        ...
                        <Form.Control type="text" value={edittedUser.newEmail} onChange={handleInput} required isInvalid={validEmail.error && !validEmail.valid} />
