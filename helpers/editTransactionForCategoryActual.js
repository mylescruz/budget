...
const editTransactionForCategoryActual = (
  edittedTransaction,
  oldTransaction,
  categories
) => {
  const updatedCategories = categories.map((category) => {
    ...
    if (category.hasSubcategory) {
      ...
      const updatedSubcategories = category.subcategories.map((subcategory) => {
        ...
        if (
          subcategory.name === oldTransaction.category &&
          subcategory.name !== edittedTransaction.category
        ) {
          ...
          if (edittedTransaction.category !== oldTransaction.category) {
            ...
            subcategoryTotal =
              ...
              edittedTransaction.amount;
            categoryTotal =
              categoryTotal - oldTransaction.amount + edittedTransaction.amount;
      ...
      category.name === oldTransaction.category &&
      ...
      if (edittedTransaction.category === oldTransaction.category) {
        ...
        categoryTotal =
          category.actual - oldTransaction.amount + edittedTransaction.amount;
      } else {
